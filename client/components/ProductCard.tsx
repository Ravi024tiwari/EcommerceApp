...
export default function ProductCard({product}:ProductCardProps) {//here we define the product props passing through the components
            ...
            <View className='relative h-56 w-full bg-gray-100'>
                ...
                {product.isFeatured && (
                    <View className='absolute top-2 left-2 bg-black px-2 py-1 rounded'>
                        <Text className='text-white text-xs font-bold px-2 rounded'>Featured</Text>
                    </View>
                )}
            </View>
