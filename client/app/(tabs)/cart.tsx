...
export default function Cart() {
  ...
  const {cartItems,cartTotal,removeFromCart,updateQuantity} =useCart();//these are the updates that we use in cartRouter
    ...
    <View className='flex-1 bg-surface'>
        ...
        {cartItems.length >0 ?(
          <>
           ...
           <View className='p-4 bg-white rounded-3xl shadow-sm'>
             {/**Subtotal */}
             ...
             <View className='flex-row justify-between mb-6'>
                  <Text className='text-primary'>Total</Text>
